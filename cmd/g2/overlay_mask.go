...
func (cfg *MainArgConfig) cmdOverlayMask(args []string) error {
	fs := flag.NewFlagSet("overlay mask", flag.ExitOnError)
	fs.Usage = func() {
		fmt.Printf("Usage:\n")
	...
	switch cmd {
	case "list":
		return cfg.cmdOverlayMaskList(fs.Args()[1:])
	case "check":
		return cfg.cmdOverlayMaskCheck(fs.Args()[1:])
	case "add":
		return cfg.cmdOverlayMaskAdd(fs.Args()[1:])
	case "remove":
		return cfg.cmdOverlayMaskRemove(fs.Args()[1:])
	case "help", "-help", "--help":
		fs.Usage()
		return nil
	default:
...
func (cfg *MainArgConfig) cmdOverlayMaskList(args []string) error {
	fs := flag.NewFlagSet("overlay mask list", flag.ExitOnError)
...
func (cfg *MainArgConfig) cmdOverlayMaskCheck(args []string) error {
	fs := flag.NewFlagSet("overlay mask check", flag.ExitOnError)
	fileOpt := fs.String("file", "profiles/package.mask", "Path to package.mask file")
...
func (cfg *MainArgConfig) cmdOverlayMaskAdd(args []string) error {
	fs := flag.NewFlagSet("overlay mask add", flag.ExitOnError)
	fileOpt := fs.String("file", "profiles/package.mask", "Path to package.mask file")
...
func (cfg *MainArgConfig) cmdOverlayMaskRemove(args []string) error {
	fs := flag.NewFlagSet("overlay mask remove", flag.ExitOnError)
	fileOpt := fs.String("file", "profiles/package.mask", "Path to package.mask file")
