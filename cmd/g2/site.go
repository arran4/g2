...
func generateAllReposPages(outDir string, tmpl *template.Template, sites []*SiteData, data *AggregatedData, title, version string, genInfo GenerationInfo) error {
...
func generateRepoMetadataPages(repoDir string, tmpl *template.Template, site *SiteData, title, version string, genInfo GenerationInfo) error {
...
func generateRepoCategoriesAndAuthorsPages(repoDir string, tmpl *template.Template, site *SiteData, title, version string, genInfo GenerationInfo) error {
...
func generateRepoDashboardPages(repoDir string, tmpl *template.Template, site *SiteData, data *AggregatedData, title, version, recentDurationStr string, genInfo GenerationInfo) error {
	cutoffDate := time.Now().AddDate(0, -3, 0)
...
func generateRepoPages(outDir string, tmpl *template.Template, sites []*SiteData, data *AggregatedData, title, version, recentDurationStr string, genInfo GenerationInfo) error {
	...
	if err := generateAllReposPages(outDir, tmpl, sites, data, title, version, genInfo); err != nil {
		return err
	}
	...
	for _, site := range sites {
		...
		if err := generateRepoMetadataPages(repoDir, tmpl, site, title, version, genInfo); err != nil {
			return err
		}

		if err := generateRepoDashboardPages(repoDir, tmpl, site, data, title, version, recentDurationStr, genInfo); err != nil {
			return err
		}

		if err := generateRepoCategoriesAndAuthorsPages(repoDir, tmpl, site, title, version, genInfo); err != nil {
			return err
		}

		if err := generateRepoPackagesAndEclassesPages(repoDir, tmpl, site, data, title, version, genInfo); err != nil {
			return err
		}
	}
...
func generateRepoPackagesAndEclassesPages(repoDir string, tmpl *template.Template, site *SiteData, data *AggregatedData, title, version string, genInfo GenerationInfo) error {
