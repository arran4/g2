...
<!--
Maintainer Note:
This README.md is partially generated by running 'go run ./cmd/g2 readme-gen'.
The current command structure in the codebase is in a transitional phase (partially using standard flags,
some custom logic, and preparing for go-subcommand). Because of this, we use an intermediate documentation model
in cmd/g2/readme_gen.go rather than perfectly inspecting the complex AST.
To update this document:
1. Edit cmd/g2/readme_gen.go to update the DocModel structures.
2. Run 'go run ./cmd/g2 readme-gen > readme.md'.
-->
